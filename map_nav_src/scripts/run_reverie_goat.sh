...
reverie_pretrain_file=${DATA_ROOT}/REVERIE/pretrain/add_register_vgllm/goat_reverie_pretrain_vgllmadd_register/ckpts/model_step_best.pt
...
outdir=${DATA_ROOT}/REVERIE/vgllm_add_register7w/
